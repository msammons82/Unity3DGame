...
// Requires many sub editors to display them.
...
public class ReactionCollectionEditor : EditorWithSubEditors<ReactionEditor, Reaction>
{
    ...
    // Represents the array of Reactions.
    private SerializedProperty reactionsProperty;

    // all the non-abstract types which inherit from Reaction. Used for adding new Reactions.
    private Type[] reactionTypes;
    // the names of all appropriate Reaction types.
    private string[] reactionTypeNames;
    // The index of the currently selected Reaction type.
    private int selectedIndex;


    // Height in pixels of the area for dropping scripts.
    private const float dropAreaHeight = 50f;
    // Width in pixels between the popup type selection and drop area. 
    private const float controlSpacing = 5f;
    // name of the field for the array of Reactions.
    ...
    {
        //Create Rect's for the top and bottom half.
    ...
    private static void DraggingAndDropping(Rect dropArea, ReactionCollectionEditor editor)
    {
        ...
        switch(currentEvent.type)
        {
            ...
            case EventType.DragUpdated:
                ...
                //...change whether or not the drag *can* be performed by changing the visual mode of the cursor on the IsDragValid function.
            ...
            case EventType.DragPerform:
                ...
                for(int i = 0; i < DragAndDrop.objectReferences.Length; i++)
                {
                    ...
                    //..then find the type of the Reaction..
    ...
    private void SetReactionNamesArray()
    {
        ...
        // Get all the types that are in the same Assembly as the Reaction type.
