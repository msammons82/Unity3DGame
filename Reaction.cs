...
public abstract class Reaction : ScriptableObject
{
    ...
    //It contains everything that is required for all Reactions as well
    // as the part of the Reaction which needs to happen immediately
    ...
    // This is the core of the Reaction and must be overridden to make things happen.
