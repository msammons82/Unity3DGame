...
public class ConditionEditor : Editor
{
    ...
    //AllConditionAsset is when the AllConditions asset is selected and this is nested Editor.
    ...
    //The SerializedProperty representing an array of Conditions on a ConditionCollection.
    public SerializedProperty conditionsProperty;


    //Represents a string description of this Editor's target.
    private SerializedProperty descriptionProperty;
    //Represents a bool of wheter this Editor's target is satisfied.
    private SerializedProperty satisfiedProperty;
    //Represents the number that identified this Editor's target is satisfied.
    private SerializedProperty hashProperty;
    //Reference to the target.
    private Condition condition;

    // Width in pixels of the button to remove this Condition from it's array.
    private const float conditionButtonWidth =30f;
    //Offset to line up the satisfied toggle with its label
    private const float toggleOffset = 30f;
    //Name of the field that represents the description
    private const string conditionPropDescriptionName ="description";
    //name of the field that represents whether or not the condition is satisfied
    private const string conditionPropSatisfiedName = "satisfied";
    //name of the field that represents the conditions identifier.
    private const string conditionPropHashName = "hash";
    //Description to use in case no Conditions have been created yet
    ...
    private void InteractableGUI()
    {
        ...
        //The width of the Popup, Toggle and remove Button.
    ...
    public static Condition CreateCondition()
    {
        ...
        //Try and set the new condition's description to the first condition in the AllCondition array.
