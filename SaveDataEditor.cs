...
public class SaveDataEditor : Editor 
{
    ...
    //Delegate for the GUI that represents bool values.
    private Action<bool> boolSpecificGUI;
    //Delegate for the GUI that represents int values.
    private Action<int> intSpecificGUI;
    //Delegate for the GUI that represents string values.
    private Action<string> stringSpecificGUI;
    //Delegate for the GUI that represents Vector3 values.
    private Action<Vector3> vector3SpecificGUI;
    //Delegate for the GUI that represents Quaternion values.
